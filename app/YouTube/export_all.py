...
def all_payment_export(request, year_month):
  for client in Client.objects.all():
    ...
    print(len(ch_revenues) + len(sr_revenues) + len(at_revenues) + len(mc_revenues))
    if len(ch_revenues) + len(sr_revenues) + len(at_revenues) + len(mc_revenues) > 0:
          ...
          insert_row_request = {'requests': [{
            "insertDimension": {
              "range": {
                ...
                "dimension": "ROWS",
                "startIndex": 22,
                "endIndex": 22 + len(ch_revenues[ag])
              },
          ...
          insert_row_request = {'requests': [{
            "insertDimension": {
              "range": {
                ...
                "dimension": "ROWS",
                "startIndex": 22,
                "endIndex": 22 + len(sr_revenues[ag])
              },
              "inheritFromBefore": True
            }
          }]}
